...
class JLPDF extends FPDF
{
 ...
 //--------------- Imprimir un parrafo-----------
 function JLprint($cad, $ANCHO, $espacio=5)
 {  
 ...
 //--------------- Imprimir un texto-----------
 function JLCell($txt, $ANCHO, $alineacion='j', $espacio=5 )
 {
  ...
  for($i=0; $i<count($parrafos); $i++)
  {
    ...
    $this->JLprint($parrafos[$i], $ANCHO, $espacio);
